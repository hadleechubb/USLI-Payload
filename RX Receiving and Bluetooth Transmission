/*********************************************************************
 This is an example for our nRF52 based Bluefruit LE modules with 
 added Rx Receiving capability
...
void loop()
{
 ...
 /* //This while statement is to send from phone to transmitter
