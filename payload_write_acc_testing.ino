...
//  {
  ...
  IMU_acclArray[count][0] = accldata.acceleration.x;
  IMU_acclArray[count][1] = accldata.acceleration.y;
  IMU_acclArray[count][2] = accldata.acceleration.z;
